...
#define OBJECTS_PRIZE_YDELTA_INITIAL_SPEED (0.025)
...
#define GAME_BOARD_PLAYER_ACCELERATION_X_FACTOR (2.2) // Factor
#define GAME_BOARD_PLAYER_ACCELERATION_Y_FACTOR (2.8) // Factor
